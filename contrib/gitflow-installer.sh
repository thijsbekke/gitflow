...
if [ -z "$REPO_HOME" ] ; then
	REPO_HOME="http://github.com/thijsbekke/gitflow.git"
fi

EXEC_FILES="git-flow"
SCRIPT_FILES="git-flow-init git-flow-feature git-flow-hotfix git-flow-release git-flow-version gitflow-common gitflow-shFlags"
